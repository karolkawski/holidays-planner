...
function Response({data, start}: {data: IScraperResponseItem[] | null; start: boolean}) {
  if (start) {
    return (
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      {data.map((scrapeInfo, index) => {
        return (
          <div key={index} className="flex w-full justify-center flex-col items-start mt-4 bg-gray-900 p-5 rounded">
            <h1>
